...
const Ofertas = () => {
  const produtos = [
    { id: 1, nome: "Smartphone TS1", preco: "R$ 1.299,99", imagem: "src/assets/smarthphonex1.png", envio: "Envio grátis", descricao: "Tela 6.5', Processador Octa-core, Câmera 48MP" },
    { id: 2, nome: "Headphone TH7", preco: "R$ 199,99", imagem: "src/assets/fonegamerTH7.png", envio: "Envio grátis", descricao: "Som estéreo, Conforto extra, Conexão sem fio" },
    { id: 3, nome: "Smartwatch TW5", preco: "R$ 349,99", imagem:  "src/assets/smartwatchTW5.png", envio: "Envio grátis", descricao: "Monitoramento de batimentos cardíacos, Bateria de longa duração" },
    { id: 4, nome: "Notebook TN Fast", preco: "R$ 2849,99", imagem: "src/assets/notebookTNFast.png", envio: "Envio grátis", descricao: "Intel i7, 16GB RAM, SSD 512GB" },
    { id: 5, nome: "Notebook TN Ultra", preco: "R$ 5779,99", imagem: "src/assets/notebookGamerTNUltra.png", envio: "Envio grátis", descricao: "Intel i9, 32GB RAM, RTX 3070, Tela 144Hz" },
  ...
  const nextSlide = () => {
    if (currentIndex < produtos.length - 3) {
